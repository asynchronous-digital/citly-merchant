...
export function Topbar({ userName = "Admin User", userRole = "Owner" }: { userName?: string; userRole?: string }) {
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            <div className="text-right hidden sm:block">
              <div className="text-sm font-semibold text-text-primary hover:text-accent transition-colors">{userName}</div>
